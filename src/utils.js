...
var CONF = {
  ...
  CONTACT_TYPE_PUBLIC:'public',
  CONTACT_TYPE_SPECIAL:'special',
...
var contentPrase = function(s){ return convertEmoji(s.replace('&lt;', '<').replace('&gt;', '>').replace('<br/>', '\n'));}

module.exports = {
  'CONF':CONF,
  'updateAPI':updateAPI,
  'convertEmoji':convertEmoji,
  'contentPrase':contentPrase
}
